...
function handleSubmit(e) {
  e.preventDefault();
  var item = e.currentTarget.item.value;
  if (!item) return;
  var itemId = Date.now();
  var itemStorage = {
    name: item,
...
function displayItemList() {
  var html = items.map(function (input) {
    return "\n        <ul class=\"list\">\n            <li class=\"shopping-item\">\n                <input \n                    type=\"checkbox\"\n                    data-id=\"".concat(input.id, "\"\n                    class=\"checkbox\"\n                    ").concat(input.isChecked && 'checked', ">\n                <span class=\"itemName\">").concat(input.name, "</span>\n                <button\n                    class=\"remove-btn\" \n                    type=\"button\"\n                    data-id=\"").concat(input.id, "\"\n                    aria-label=\"remove\">\n                    &times\n                </button>\n            </li>\n        </ul>\n        ");
  }).join('');
  list.innerHTML = html;
}
...
function getItemsFromLS() {
  ...
  var localItemsList = JSON.parse(localStorage.getItem('items'));

  (_items = items).push.apply(_items, _toConsumableArray(localItemsList));
...
function handleChecked(id) {
  var clickedItem = items.find(function (clickedObj) {
    return clickedObj.id === id;
  });
...
list.addEventListener('click', function (event) {
  ...
  if (event.target.matches(".checkbox")) {
    var _id = parseInt(event.target.dataset.id);

    return handleChecked(_id);
  }
